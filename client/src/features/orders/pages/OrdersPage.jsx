    ...
    useEffect(() => {
        ...
        const fetchOrders = async () => {
            try {
                ...
                const data = await orderService.getMyOrders(controller.signal);
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            {loading ? (
                <div className="space-y-4">
                    {[...Array(3)].map((_, i) => (
                        <div key={i} className="border border-slate-100 rounded-2xl p-6 bg-white flex flex-col gap-4">
                            ...
                            <div className="flex justify-between items-center pt-4 border-t border-slate-100 mt-2">
                                <div className="h-6 w-1/6 rounded shimmer" />
                                <div className="h-6 w-1/5 rounded-full shimmer" />
                            </div>
                        </div>
                    ))}
                </div>
